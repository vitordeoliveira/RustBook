...
// A parent node should own its children: if a parent node is dropped, its child nodes should be
// dropped as well. However, a child should not own its parent: if we drop a child node, the parent
