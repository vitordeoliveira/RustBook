...
impl Post {
    ...
    pub fn content(&self) -> &str {
        ...
        // the Option rather than ownership of the value
        // We then call the unwrap method, which we know will never panic, because we know the
        // methods on Post ensure that state will always contain a Some value when those methods
        // are done
